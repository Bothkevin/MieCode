...
def a_Lb_L_core_shell(n, k, n_m, R):
    q = False
    filecounter = 0
    L = 1
    n_complex = n - 1j*k
    ...
    while q == False:
        ...
        for i in range(h):
            ...
            #print(f'very good very nice{(T_L[i,:])}')
            ...
            #print(f'very good very nice S{S_L[i+1,:]}')
        #T_L2 = -(m*jn_Lmx*(jnder_Lx+T_L1*ynder_Lx)-jnder_Lmx*(jn_Lx+T_L1*yn_Lx))/(m*yn_Lmx*(jnder_Lx+T_L1*ynder_Lx)-ynder_Lmx*(jn_Lx+T_L1*yn_Lx))
        #S_L2 = -(jn_Lmx*(jnder_Lx+S_L1*ynder_Lx)-m*jnder_Lmx*(jn_Lx+S_L1*yn_Lx))/(yn_Lmx*(jnder_Lx+S_L1*ynder_Lx)-m*ynder_Lmx*(jn_Lx+S_L1*yn_Lx))
        ...
        #for calculating only one T value
        #a_L = -(m*jn_Lmx*(jnder_Lx+T_L1*ynder_Lx)-jnder_Lmx*(jn_Lx+T_L1*yn_Lx))/(m*xin_Lmx*(jnder_Lx+T_L1*ynder_Lx)-xinder_Lmx*(jn_Lx+T_L1*yn_Lx))
        #b_L = -(jn_Lmx*(jnder_Lx+S_L1*ynder_Lx)-m*jnder_Lmx*(jn_Lx+S_L1*yn_Lx))/(xin_Lmx*(jnder_Lx+S_L1*ynder_Lx)-m*xinder_Lmx*(jn_Lx+S_L1*yn_Lx))
